...
@CustomItemStack
public class LowerNavigationVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.LowerNavigation.name(); }

    @Override
    public Material itemType() { return GameTaskArea.LowerNavigation.ventMaterial; }
