...
@CustomItemStack
public class UpperReactorVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.UpperReactor.name(); }

    @Override
    public Material itemType() { return GameTaskArea.UpperReactor.ventMaterial; }
