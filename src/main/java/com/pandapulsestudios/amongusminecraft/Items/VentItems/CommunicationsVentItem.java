...
@CustomItemStack
public class CommunicationsVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.Communications.name(); }

    @Override
    public Material itemType() { return GameTaskArea.Communications.ventMaterial; }
