...
@CustomItemStack
public class LowerReactorVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.LowerReactor.name(); }

    @Override
    public Material itemType() { return GameTaskArea.LowerReactor.ventMaterial; }
