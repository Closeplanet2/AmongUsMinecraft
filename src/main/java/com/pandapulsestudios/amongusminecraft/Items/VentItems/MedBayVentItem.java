...
@CustomItemStack
public class MedBayVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.MedBay.name(); }

    @Override
    public Material itemType() { return GameTaskArea.MedBay.ventMaterial; }
