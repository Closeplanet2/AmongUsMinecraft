...
@CustomItemStack
public class CafeteriaVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.Cafeteria.name(); }

    @Override
    public Material itemType() { return GameTaskArea.Cafeteria.ventMaterial; }
