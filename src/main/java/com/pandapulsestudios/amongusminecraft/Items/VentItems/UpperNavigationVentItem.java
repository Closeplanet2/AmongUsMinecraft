...
@CustomItemStack
public class UpperNavigationVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.UpperNavigation.name(); }

    @Override
    public Material itemType() { return GameTaskArea.UpperNavigation.ventMaterial; }
