...
@CustomItemStack
public class LowerEngineVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.LowerEngine.name(); }

    @Override
    public Material itemType() { return GameTaskArea.LowerEngine.ventMaterial; }
