...
@CustomItemStack
public class StorageVentITem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.Storage.name(); }

    @Override
    public Material itemType() { return GameTaskArea.Storage.ventMaterial; }
