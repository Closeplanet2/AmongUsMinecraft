...
@CustomItemStack
public class ElectricalVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.Electrical.name(); }

    @Override
    public Material itemType() { return GameTaskArea.Electrical.ventMaterial; }
