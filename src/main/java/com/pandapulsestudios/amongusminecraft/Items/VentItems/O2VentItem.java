...
@CustomItemStack
public class O2VentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.O2.name(); }

    @Override
    public Material itemType() { return GameTaskArea.O2.ventMaterial; }
