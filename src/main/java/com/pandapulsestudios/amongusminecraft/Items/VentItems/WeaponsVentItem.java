...
@CustomItemStack
public class WeaponsVentItem implements PulseItemStack {
    @Override
    public String itemName() { return GameTaskArea.Weapons.name(); }

    @Override
    public Material itemType() { return GameTaskArea.Weapons.ventMaterial; }
